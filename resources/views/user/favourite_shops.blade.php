...
@section('content')
    <section class="container restaurant">
        ...
        <div class="row">
            <div class="col-12">
                <div class="row mb-3">
                    @foreach($favouriteShops as $s)
                        <div class="col-6">
                            <a href="{{url('restaurant-menu/'.$s->favourite_shop_id)}}" style="color: black;text-decoration: none">
                                <div class="restaurant_card-detail d-flex align-items-center">
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-center">
                                                <img src="{{asset('shop-profile/'.$s->getShop->profile_image)}}" alt="" style="width: 100px;height: 100px">
                                            </div>
                                            <div class="overflow-hidden">
                                                <p class="font-weight-bolder text-center text-nowrap">{{$s->getShop->name}}</p>
